<template>
    ...
    <main>
        <div class="compileBox">
            <div class="title">
                ...
                <div>
                    <a-upload name="file" action="http://adapter.xmig6.cn/sqp/api/upload" @change="handleChange"
            ...
            <a-spin :spinning="loading">
                ...
                <div v-else class="explain">
                    ...
                    <p>2. 题型：支持导入单选题、多选题、填空题、判断题、简答题、阅读理解、完形填空题型，若要导入其他题型请用【题型名称】如【名词解释】、【计算题】在题干前标注不同的题型，否则会识别为简答题。</p>
    ...
    <footer>
        <a-space>
            <a-button type="primary" @click="console.log(data)">确认导入</a-button>
